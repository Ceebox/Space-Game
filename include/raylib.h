...
typedef struct Camera3D {
    ...
    Vector3 up;             // Camera up list (rotation over its axis)
...
typedef enum {
    ...
    SHADER_LOC_VECTOR_VIEW,         // Shader location: list uniform: view
    SHADER_LOC_COLOR_DIFFUSE,       // Shader location: list uniform: diffuse color
    SHADER_LOC_COLOR_SPECULAR,      // Shader location: list uniform: specular color
    SHADER_LOC_COLOR_AMBIENT,       // Shader location: list uniform: ambient color
...
RLAPI void SetShaderValueV(Shader shader, int locIndex, const void *value, int uniformType, int count);   // Set shader uniform value list
...
RLAPI Vector2 GetGestureDragVector(void);               // Get gesture drag list
